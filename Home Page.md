...
const nav = [
  ["📖 知识库", [
    ...
    ["Wiki/wiki/log", "📝 操作日志"],
    ["教程/学习AI/04-知识库与RAG/知识库技术学习指南", "🧠 知识库技术"],
  ]],
  ["🤖 Claude Code", [
...
```dataviewjs
const tut = [
  ["教程/学习AI/03-AI编码工具/AI Coding 学习计划", "📖 AI Coding 学习计划", "从零开始的系统学习路径（1072 行）→ 发展历程 / 五大工具 / Agent / 拓展"],
  ["教程/学习AI/04-知识库与RAG/知识库技术学习指南", "🧠 知识库技术学习指南", "知识库技术总纲（451 行）→ RAG / 优化 20 法 / 知识图谱 / LLM Wiki"],
