...
| 天数 | 学习内容 | 实战产出 | 对应章节 |
|------|---------|---------|------------|
| Day 1 | Ollama 安装、模型下载与量化选型、API 调用、三层策略 | 本地可用的编程助手模型 | [[01-Ollama本地部署\|第一章]] |
| Day 1-2 | LLM 基础理论、训练三阶段、Token 原理、模型选型、幻觉抑制 | 《程序员大模型选型手册》 | [[02-LLM底层认知\|第二章]] |
