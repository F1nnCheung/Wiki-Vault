...
type: topic
tags: [ai-coding, learning-plan, roadmap]
created: 2026-05-09
updated: 2026-05-09
sources: []
related:
...
> 📖 想要一份包含完整安装步骤、命令速查、MCP/Skills 生态图谱的综合教程？查看 [[教程/学习AI/05-AI Coding/00-AI Coding 学习计划|AI Coding 完整学习计划]]

## 🎯 学习目标

从零开始，系统掌握 AI 辅助编程的核心理念、工具生态和实战能力。本路线按 **概念认知 → 工具实操 → 进阶工作流** 三阶段递进。
...
| 概念 | 一句话 |
|---|---|
| **Vibe Coding** | 用自然语言描述需求，让 AI「凭感觉」生成代码 |
| **Agentic Engineering** | 多 AI 智能体自主规划→编写→测试→审查 |
| **MCP** | AI 连接外部工具的标准协议（USB-C 类比） |
| **Skills** | 给 AI 安装的可复用「能力包」 |
| **Agent** | 能自主规划并执行多步任务的 AI |
...
4. **保持跟进**：AI Coding 领域每月有新变化，定期查看本 wiki 更新
...
> 📖 导航：[[../overview|全局概览]] · [[ai-coding-concepts|核心概念]] · [[ai-coding-history|发展史]] · [[ai-coding-tools-comparison|工具对比]] · [[../../教程/学习AI/05-AI Coding/00-AI Coding 学习计划|完整教程]]
