...
> 📖 想要一份包含完整安装步骤、命令速查、MCP/Skills 生态图谱的综合教程？查看 [[教程/学习AI/05-AI Coding/00-AI Coding学习指南|AI Coding 完整学习计划]]
...
> 📖 导航：[[../overview|全局概览]] · [[ai-coding-concepts|核心概念]] · [[ai-coding-history|发展史]] · [[ai-coding-tools-comparison|工具对比]] · [[../../教程/学习AI/05-AI Coding/00-AI Coding学习指南|完整教程]]
