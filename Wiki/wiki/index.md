...
- [LLM 与 Prompt 工程学习指南](../../教程/学习AI/01-LLM与Prompt工程/LLM与Prompt工程学习指南.md) — 📖 第 1 周教程（2026-06-02 完善）：LLM 底层认知 → Prompt 工程三板斧（含动态路由/组合策略/六大坑）→ 8 套代码专用 Prompt 模板 → 代码场景常见坑 → Spec-Driven 开发 → Prompt 版本管理与测试
