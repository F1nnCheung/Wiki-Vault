...
- **教程同步**：教程/学习AI/03-AI编码工具/00-AI Coding 学习计划.md（末尾「推荐进一步阅读」添加了 AI Agent 学习指南链接）
...
- **教程同步**：
  ...
  - 教程/学习AI/03-AI编码工具/00-AI Coding 学习计划.md（Codex 章节全面更新：四大形态/核心工作流/适用场景表格/工具占比更新）
...
- **教程同步**：教程/学习AI/03-AI编码工具/02-主流AI Coding工具/02-Claude-Code/02-安装与配置.md（CLAUDE.md 写作原则段落新增引用）、教程/学习AI/03-AI编码工具/00-AI Coding 学习计划.md（Rule 概念段落新增延伸阅读）、教程/学习AI/03-AI编码工具/02-主流AI Coding工具/02-Claude-Code/06-高阶指令.md（Q&A 段落新增 12 条规则引用）
...
- **教程同步**：教程/学习AI/03-AI编码工具/02-主流AI Coding工具/02-Claude-Code/04-进阶使用-Skill.md（Skill 生态资源表新增 ECC + 更新时间）、教程/学习AI/03-AI编码工具/04-拓展使用/03-其他拓展工具与场景.md（新增 ECC 专题章节 + 与逐个安装 Skill 的对比表 + 更新时间）、教程/学习AI/03-AI编码工具/00-AI Coding 学习计划.md（精选 Skill 表新增 ECC + Obsidian 推荐 Skill 段落新增 ECC + 4.3 章节标题更新）
...
- **新增输出产物（1 个）**：
  - 教程/学习AI/03-AI编码工具/00-AI Coding 学习计划.md — 1072 行综合教程，包含四大章节
- **教程结构**：
...
- 教程同步：教程/学习AI/03-AI编码工具/00-AI Coding 学习计划.md（4.2 Superpowers+gstack 章节补充跨平台说明和设计哲学链接）
